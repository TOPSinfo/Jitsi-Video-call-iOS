...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // MARK: Instance of windows of apllication
    var window: UIWindow?
    var currentCallId: String = ""
    var objCurrentUser: SignupUserData = SignupUserData()
    var arrForActiveCallList: [ActiveCallList] = []
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "SampleCodeiOS")
