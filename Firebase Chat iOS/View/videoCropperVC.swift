...
class VideoCropperVC: UIViewController {
    ...
    @IBOutlet weak var lblPalyPause: UILabel!
    ...
    @objc func itemDidFinishPlaying(_ notification: Notification) {
        ...
        DispatchQueue.main.async {
            ...
            self.btnPlayPause.setImage(#imageLiteral(resourceName: "button_play"), for: .normal)
            self.lblPalyPause.text = "Play"
        }
    }
    ...
    func startPlaybackTimeChecker() {
        ...
        self.lblRemainingTime.text = String(format: "%02d:%02d", 0, counter)
    ...
    @IBAction func seekSlidervalue(_ sender: UISlider) {
        ...
        player?.play()
        btnPlayPause.setImage(#imageLiteral(resourceName: "pauseBtn"), for: .normal)
        startPlaybackTimeChecker()
    }
